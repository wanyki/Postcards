...
本项目在 **Gemini与Mimo** 的协助下完成，旨在记录每一份漂洋过海的祝福，并可视化展示我的足迹分布。
...
- **📊 数据中心**：可视化数据面板，包含收发趋势、热门地区、漂流时长分布等多种图表。
...
![DashBoardImage](DashBoardImage.jpg)
------

> 📋 完整更新日志请查看 [CHANGELOG.md](./CHANGELOG.md)

---
<p align="center"><font color="#999999"><small>本项目所有内容均由 Gemini与Mimo 协助完成</small></font></p>
